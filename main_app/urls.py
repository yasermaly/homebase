...
urlpatterns = [
    ...
    path('homes/<int:home_id>/assoc_amenity/<int:amenity_id>/', views.assoc_amenity, name='assoc_amenity'),
    ...
    path('amenitites/<int:pk>/', views.AmenityDetail.as_view(), name='amenity_detail'),
